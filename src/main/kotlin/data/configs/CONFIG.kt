...
data class CONFIG(
    ...
    @SerialName("jvm8") var jvm8: String = "java",
    @SerialName("jvm16") var jvm16: String = "java",
    @SerialName("jvm17") var jvm17: String = "java",
    @SerialName("jvm21") var jvm21: String = "java",
    @SerialName("jvm25") var jvm25: String = "java",
) : Configurable<CONFIG> {
